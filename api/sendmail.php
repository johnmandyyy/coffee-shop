...
function sendMail($data)
{
    ...
    try {
        ...
        $mail->addAddress($data['recepient'], 'Recepient');     //Add a recipient
        ...
        // list($type, $data) = explode(';', string: $data['attachment']); // Separate MIME type and data
