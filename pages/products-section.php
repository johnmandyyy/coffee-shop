<div class="col-lg-12">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="coffee-tab" data-bs-toggle="tab" data-bs-target="#coffee" type="button"
                role="tab" aria-controls="home" aria-selected="true">Coffee Based</button>
        </li>
        ...
        <li v-if="is_logged === true && loyalty_flag === '1'" class="nav-item" role="presentation">
            <button class="nav-link" id="free-tab" data-bs-toggle="tab" data-bs-target="#free" type="button" role="tab"
                aria-controls="previous" aria-selected="false">
