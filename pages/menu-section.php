    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-12">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="milktea-tab" data-bs-toggle="tab" data-bs-target="#milktea"
                        type="button" role="tab" aria-controls="milktea" aria-selected="false">Milktea</button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li v-if="is_logged === true" class="nav-item" role="presentation">
                    <button class="nav-link" id="previous-tab" data-bs-toggle="tab" data-bs-target="#previous"
                        type="button" role="tab" aria-controls="previous" aria-selected="false">
